      ...
      <ul className="navbar-nav">
        <li className="nav-item dropdown">
          ...
          <ul className="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
            <li><a className="dropdown-item" href="#">Html cơ bản</a></li>
            <li><a className="dropdown-item" href="#">Css cơ bản</a></li>
            <li><a className="dropdown-item" href="#">JavaScript cơ bản</a></li>
          </ul>
        </li>
      </ul>
    </div>
